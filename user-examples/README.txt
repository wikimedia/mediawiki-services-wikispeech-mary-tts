...
java -Dmary.base="target/marytts-5.2-SNAPSHOT" -cp "target/marytts-5.2-SNAPSHOT/lib/*:user-examples/example-embedded/target/example-embedded-5.2-SNAPSHOT.jar" example.MaryTTSEmbedded
